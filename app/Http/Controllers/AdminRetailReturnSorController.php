...
use PHPExcel_Style_Fill;
	...
	class AdminRetailReturnSorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_before_edit(&$postdata,$id) {        
			...
			if($ReturnRequest->diagnose == "REPLACE"){
				...
				if($ReturnRequest->transaction_type_id == 1){
...
/*
	    ...
	    */
		...
		public function ReturnsSOREditRTL($id)
		{
			$this->cbLoader();
			...
			->leftjoin('cms_users as crf', 'returns_header_retail.level8_personnel','=', 'crf.id')																		
