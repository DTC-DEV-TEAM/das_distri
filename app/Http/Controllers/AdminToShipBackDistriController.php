...
use App\StoresFrontEnd;
	...
	class AdminToShipBackDistriController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		public function ReturnsReturnFormPrintDISTRI($id)
		{
			...
			$store_id = 	StoresFrontEnd::where('store_name', $data['row']->store_dropoff )->where('channels_id', 4 )->first();
