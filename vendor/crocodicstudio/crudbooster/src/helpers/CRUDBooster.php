...
class CRUDBooster
{
    ...
    public static function myStoreId()
    {
        return Session::get('admin_store_id');
    }

    public static function myChannelId()
    {
    ...
    public static function sidebarDashboard()
    {
        ...
        // $menu = Cache::remember('menu_active', 3600, function () {
        //     return DB::table('cms_menus')->whereRaw("cms_menus.id IN (select id_cms_menus from cms_menus_privileges where id_cms_privileges = '".self::myPrivilegeId()."')")->where('is_dashboard', 1)->where('is_active', 1)->first();
        // });
    ...
    {
        // $menu_active = Cache::remember('menu_active', 3600, function () {
        //     return DB::table('cms_menus')->whereRaw("cms_menus.id IN (select id_cms_menus from cms_menus_privileges where id_cms_privileges = '".self::myPrivilegeId()."')")->where('parent_id', 0)->where('is_active', 1)->where('is_dashboard', 0)->orderby('sorting', 'asc')->select('cms_menus.*')->get();
        // });
