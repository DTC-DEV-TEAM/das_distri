...
<head>
    <meta charset="UTF-8">
    <title>{{trans("crudbooster.page_title_login")}} : DAS</title>
...
<!--<script> 
    document.onload = setTimeout(function () { alert('This is the official site of Merchandising Pullout System. Testing or conducting questionable transactions have a corresponding sanction.'); }, 200);
</script>-->
