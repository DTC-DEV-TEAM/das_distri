                        ...
                        <li class="user-footer">
                            <div class="pull-{{ trans('crudbooster.left') }}">
                                <a href="{{ route('AdminCmsUsersControllerGetProfile') }}" class="btn btn-default btn-flat"><i
                                    class='fa fa-user'></i><small class="text-success"> {{trans("crudbooster.label_button_profile")}}</small></a>
                                <a href="{{ route('show-change-password') }}" class="btn btn-default btn-flat">
                                    <i class='fa fa-key text-success'></i> 
                                    <small class="text-success">Account</small>
                                </a>
                            </div>
                            <div class="pull-{{ trans('crudbooster.right') }}">
                                <a title='Lock Screen' href="{{ route('getLockScreen') }}" class='btn btn-default btn-flat'><i class='fa fa-lock text-warnig'></i></a>
