                    ...
                    <table class="custom_normal_table">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="customer_location" id="customer_location" required style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="" name="deliver_to" id="deliver_to" required style="width:100%">
                    ...
                    <table class="custom_table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="js-example-basic-single" name="mode_of_return" id="mode_of_return" required style="width:100%" onchange="mode_change()">
                                        @if(  $row->mode_of_return == "DOOR-TO-DOOR")
                                                <option selected value="DOOR-TO-DOOR">Door-to-Door (Cash on Pick-up)</option>
                            ...
                            <tr id="dropoff">
                                ...
                                @if ($row->branch_dropoff != null || $row->branch_dropoff != "")
                                    ...
                                    <td>
                                        <select class="js-example-basic-single" name="branch_dropoff" id="branch_dropoff" required style="width:100%">
                            ...
                            @if (!empty($resultlist)) 
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center" height="10">{{$rowresult->problem_details}}
                                        ...
                                        @endif
                                        <input type="hidden" value="{{$rowresult->problem_details}}" name="problem_details_text" id="problem_details_text">
                                        <input type="hidden" value="{{$rowresult->problem_details_other}}" name="problem_details_other_text" id="problem_details_other_text">
                                    </td>                    
                                </tr>
                                @endforeach
                            @endif
                            ...
                            <div class="box-body no-padding">
                                <div class="table-responsive">
                                    <div class="pic-container">
                                        <div class="pic-row">
                                            <table class="table table-bordered table-font" id="pullout-items">
                                                <tbody>
...
function mode_change(){
    var change_mode = document.getElementById("mode_of_return").value;
    
    
    if( change_mode =="DOOR-TO-DOOR"){
            $('#dropoff').hide();
             $('#store_dropoff').attr("required", false);
    }else{
            $('#dropoff').show();
            $('#store_dropoff').attr("required", true);
...
function showCustomerLocation(){
        ...
        $.ajax
        ({ 
            url: '{{ url('admin/scheduling/backend_stores') }}',
            type: "POST",
            data: {
...
function branchChange(){
        ...
        $.ajax
        ({ 
            url: '{{ url('admin/scheduling/branch_change') }}',
            type: "POST",
            data: {
    ...
    function showBranch()
    {
        ...
        $.ajax
        ({ 
            url: '{{ url('admin/scheduling/branch_drop_off') }}',
            type: "POST",
            data: {
        ...
        select: function (event, ui) {
            ...
            if (e.id) {
                if (!in_array(e.stock_code, stack)) {
                   ...
                   $("problem_details_"+ e.id).attr('disabled','disabled');
                  ...
                  $('#problem_details_'+e.id).change(function(){
                   ...
                   // $('.tableInfo').show();
                    ...
                    if(!related_items.includes(e.stock_code)){
                        ...
                        Swal.fire({
                            title: "You can not add this item!",
                            icon: 'warning',
                            showCancelButton: false,
                            confirmButtonColor: '#3085d6',
                            confirmButtonText: 'Ok',
