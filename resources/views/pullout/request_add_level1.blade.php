        ...
        <div class='panel-body'>
            <form action="{{ CRUDBooster::mainpath('add-save') }}" method="POST" id="pulloutForm" enctype="multipart/form-data">
                ...
                <input type="hidden" value="{{ $channel_type->channel_name }}" name="channel_id" id="channel_id">
                 <input type="hidden" value="2" name="image_item" id="image_item">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='number'  name='mobile_number' id="mobile_number" autocomplete="off" class='form-control'  placeholder="Mobile#" onKeyPress="if(this.value.length==11) return false;" onkeyup="myFunction()"/> 
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(from_checking.includes("CLEARANCE")) {
                        ...
                        if($("#reasons_id").val() == "9" || $("#reasons_id").val() == 9  || $("#reasons_id").val() == "25" || $("#reasons_id").val() == 25 || $("#reasons_id").val() == "28" || $("#reasons_id").val() == 28){
                            restriction = 0;
                        }else{
                            restriction++;   
                        }                 
            	    if(rowCount == 2){
                    ...
                    }else if($("#reasons_id").val() == "9" || $("#reasons_id").val() == 9  || $("#reasons_id").val() == "25" || $("#reasons_id").val() == 25 || $("#reasons_id").val() == "28" || $("#reasons_id").val() == 28){
                         myStr = data.sample;
                        if (data.status_no == 1) {
                            $("#val_item").html();
                            var data = data.items;
                        ...
                        if($("#reasons_id").val() == "3" || $("#reasons_id").val() == 3){
