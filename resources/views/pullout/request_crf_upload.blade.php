...
@endif
  <div class='panel panel-default'>
    ...
    <div class='panel-body'>
            <form method='POST' id="myform" action="{{route('pulloutonl.item.crf')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <table width="100%">
                        <tr>
                                <td width="17%">
                                    <label class="control-label col-md-12"><strong>Bank Slip Upload:<strong></label>
                                </td>
                                <td colspan="3">
                        ...
                        <td colspan="4">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <h4 align="left"  style="margin-top: 17px;"><strong>CUSTOMER RETURN FORM</strong></h4> 
                                    </td>
                                </tr>     
                            </table>   
                            <hr color="black" >
