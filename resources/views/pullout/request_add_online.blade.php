      ...
      <div class='panel-heading'>Pullout Request Form</div>
        <div class='panel-body'>
            <form action="{{ CRUDBooster::mainpath('add-save') }}" method="POST" id="pulloutForm"  enctype="multipart/form-data">
                ...
                <input type="hidden" value="{{ $online_validation }}" name="onl_validation" id="onl_validation">
                <input type="hidden" value="{{ $show }}" name="show_field" id="show_field">
                
                 <input type="hidden" value="{{ $channel_type->channel_name }}" name="image_item" id="image_item">
                    ...
                    <div class="row">
                       <!-- <div class="col-md-4">
                            <div class="form-group">
                                <label class="require control-label">{{ trans('message.form-label.srof_number') }}</label>
                                <input type='input' required name='srof_number' id="srof_number"  autocomplete="off" class='form-control' maxlength="50" placeholder="SROF#" /> 
                            </div>
                        </div> -->
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <label  class="control-label" style="color:red; font-style: italic;">*If the same SKUs, create only one request. *If different SKUs, create another pullout request.</label>
                    ...
                    <legend class="scheduler-border" style="color:red;">&nbsp;SROF Details</legend>
                        ...
                        <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='input' required name='first_name' id="first_name" autocomplete="off" class='form-control' maxlength="50" placeholder="First Name" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='input' required name='last_name' id="last_name" autocomplete="off" class='form-control' maxlength="50" placeholder="Last Name" /> 
                                        </div>
                                    </div>
                        </div>
                        <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                                ...
                                                <input type='input' required name='address' id="address" autocomplete="off" class='form-control' maxlength="250" placeholder="Address" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='input' required name='email_address' id="email_address" autocomplete="off" class='form-control' maxlength="50" placeholder="Email Address" /> 
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='input' required name='company_store' id="company_store" autocomplete="off" class='form-control' maxlength="250" placeholder="Company" /> 
                                                <p style="font: italic bold 12px/30px arial, arial;">Type N/A if not applicable</p>
                                        </div>
                                </div>
                        </div>
                        ...
                        <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='input'  name='work_number' id="work_number" autocomplete="off" class='form-control' maxlength="35" placeholder="Work#" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='input'  name='home_number' id="home_number" autocomplete="off" class='form-control' maxlength="35" placeholder="Home#" /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                ...
                                                <input type='number'  name='mobile_number' id="mobile_number" autocomplete="off" class='form-control' maxlength="11" placeholder="Mobile#" onKeyPress="if(this.value.length==11) return false;" onkeyup="myFunction()"/> 
                        ...
                        <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input class="form-control" required name="date_purchased" id="datepicker2" onkeydown="return false" tabindex="0" autocomplete="off" type="input" placeholder="yyyy-mm-dd">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                            ...
                                            <input type='input' required name='rs_invoice_number' id="rs_invoice_number" autocomplete="off" class='form-control' maxlength="50" placeholder="INV#" onkeypress="return AvoidSpace(event)" /> 
                                    </div>
                                </div>
                        </div>
                        
                        <!--@if($transac_type == 2 || $transac_type == 1)
                        <div class="row">
                            <div class="col-md-8">
                            <div class="form-group">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-multiple"  name="items_included[]" id="items_included" multiple="multiple" required  style="width:100%">
                       ...
                       <!-- <hr color="black" > 
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="radio-inline control-label col-md-5"><input type="radio" required  name="action_taken_type" value="{{$data->action_taken}}" >{{$data->action_taken}}</label>
                                    <br>
                                </div>
                                 @endforeach
                        </div>
                        ...
                        <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                            <label class="require control-label">{{ trans('message.form-label.diagnosis') }}</label>
                                        <select class="js-example-basic-multiple" required name="diagnosis[]" id="diagnosis" multiple="multiple" required style="width:100%">
                                                @foreach($store_diagnosis_list as $datas)     
                                                    <option value="{{$datas->store_diagnosis_description}}">{{$datas->store_diagnosis_description}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                <br>
                                                <input type='input'  name='other_store_diagnosis' id="other_store_diagnosis" autocomplete="off" class='form-control' maxlength="50" placeholder="OTHER DIAGNOSIS" style="height:40px;" /> 
                                    </div>
                                </div>
                        </div> -->
                        <hr color="black" > 
                        <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                            ...
                                            <input type='input' required name='prepared_by' id="prepared_by" autocomplete="off" class='form-control' maxlength="50" placeholder="First Name Last Name" /> 
                                    </div>
                                </div>
                                @if($item_image == 1)
                                    @if($channel_type->channel_name == "RETAIL")
                                        <div class="col-md-4">
                                                <div class="form-group">
                                                        <label class="require control-label">*Item Image:</label>

                                                        <input id="file-input" type="file" name="srof_image[]" multiple required multiple accept="image/*" style="border: 1px solid black;">
...
$(document).ready(function() {
    ...
    $("#btnSubmit").on('click',function() {
       ...
       if(signal != 0){
            ...
            }else if(alert_message == 10){
                 alert("Complete is not allowed in items inclusion!");
            }else{
...
function reply_click1(clicked_id)
  {
        ...
        $.ajax({
             type: 'GET',
             url: '{{ url('admin/pullout_stw/SoftDeleteSerail') }}',
             data: data,
...
$("#save_serial").on('click',function(){
        ...
        if (strconfirm == true) {
            var data = $('#myform').serialize();
                ...
                $.ajax({
                        type: 'GET',
                        url: '{{ url('admin/pullout_stw/AddSerail') }}',
                        data: data,
                        success: function(data){
