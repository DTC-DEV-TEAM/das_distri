        ...
        <div class='panel-heading'>Edit Form</div>
            <div class='panel-body'>
             <div id="printableArea"> 
                    ...
                    <form method='POST' id="myform" action="{{route('pulloutonl.item.drupload')}}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="{{$row->id}}" name="id">  
                        ...
                        @if($row->returnscheduled != null )
                            <div class="row"> 
                                    <label class="control-label col-md-2">Return Date:</label>
                                    <div class="col-md-4">
                                            <p>{{$row->return_schedule}}</p>
                                    </div> 
                                    <label class="control-label col-md-2">Return Scheduled By:</label>
                                    <div class="col-md-4">
                                        @if($row->returnscheduled != null )
                                                <p>{{$row->returnscheduled}}</p>
                                            @else
                                                ____________________
                                        @endif
                                    </div>                            
