    ...
    <div class='panel panel-default'>
      <div class='panel-heading'>Pullout Request Form</div>
        <div class='panel-body'>
            <form action="{{ CRUDBooster::mainpath('add-save') }}" method="POST" id="pulloutForm">
                ...
                <input type="hidden"  name="deliver_to" id="deliver_to">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" id="carry_division">
                            ...
                            <input class="form-control" type="text" name="hand_carry_by" id="hand_carry_by"  placeholder="Hand Carried By">
                        </div>
                    </div>
                </div>
            </fieldset>
            ...
            <legend class="scheduler-border" style="color:red;">&nbsp;Pullout Items</legend>
                <div class="row">
                    ...
                    <!--<div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label" style=" font-size: 13px;">Upload ST Format</label>
...
/*$(document).ready(function () {
 $("#excel-form").submit(function(e){
    ...
    $.ajax({
     url: "{{ route('pullout.upload.excel-sts') }}",
     type: "POST",
     ...
     success: function(data){
        ...
        var pos_store_to = $("#pull_out_deliver_to option:selected").text();

       // alert(data['pos_serach_store']);
        var storename = JSON.stringify(data['pos_serach_store']);
        ...
        if(!storename.includes(pos_store_to)){
            count++;
        }
...
$(document).ready(function () {
 $("#excel-form1").submit(function(e){
    ...
    $.ajax({
     url: "{{ route('pullout.upload.excel-sts1') }}",
     type: "POST",
     mimeTypes:"multipart/form-data",
     contentType: false,
     cache: false,
