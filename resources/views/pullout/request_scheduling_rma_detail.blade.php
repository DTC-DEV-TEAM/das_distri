            ...
            <div class="row">
                    <div class="col-sm-12 col-xs-12">
                            <form method='' id="myform" action="">
                                 @if ($row->pullout_status == NULL) 
                                <input type='submit' class='btn btn-primary' id="save" name="save" onclick="printDivision('printableArea')" value='Print as PDF'/>
                                 @else
                                ...
                                <input type="hidden" value="{{ $row->pullout_status}}" name="pullout_status" id="pullout_status">    
                            </form>
                    </div>
            </div>     
    </div>
        ...
        <div id="printableArea"> 
            <table width="100%">
                       ...
                       <!-- @if($row->pullout_type == "rma") 
                        ...
                        <td>
                            @if($row->approved_at_level2 == null)
                                ____________________
                            @else 
                                <p>{{ $row->approved_at_level2 != null ? date('Y-m-d', strtotime($row->approved_at_level2)) : ""}}</p>
                            @endif
                        </td>                        
                    </tr>
                    <tr style="font-size: 13px;">
                    ...
                    <tr style="font-size: 13px;">
                        ...
                        <td width="40%">
                            <p>{{date('Y-m-d', strtotime($row->return_schedule))}}</p>
                        </td>
                        <td width="20%">
                    ...
                    <tr style="font-size: 13px;">
                            <td width="20%">
                                <label class="control-label col-md-12"><strong>Revise ST#/Ref#:<strong></label>
                            </td>
                            <td width="40%">
                                <p>{{$row->revise_st_number_pull_out}}</p> 
                            </td>
                            <td width="20%">
                                <label class="control-label col-md-12"><strong>Revise SOR#/MOR#:</strong></label>
                            </td>
                            <td>
    ...
    <script type="text/javascript">
        ...
        //var strconfirm = confirm("Are you sure you want to approve this pull-out request?");
            var data = $('#myform').serialize();
                $.ajax({
                        type: 'GET',
                        url: '{{ url('admin/pullout_requests/LogisticsUpdateStatus') }}',
                        data: data,
