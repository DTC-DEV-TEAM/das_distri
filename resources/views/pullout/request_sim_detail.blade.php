             ...
             <div> 
                <form method='post' id="myform" action='{{CRUDBooster::mainpath('edit-save/'.$row->id)}}'>
                    <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                        ...
                        <hr color="black">
                        <div class="row"> 
                                <label class="control-label col-md-2">Pullout Status:</label>
                                <div class="col-md-4">
                                        <p>{{$row->pullout_status}}</p>
                                </div> 
                                 <label class="control-label col-md-2">Cancelled By:</label>
                                <div class="col-md-4">
                                         <p>{{$row->iclevel}}</p>
                                </div>                            
                        </div>
                        <div class="row"> 
                                <label class="control-label col-md-2">Cancelled At:</label>
                                <div class="col-md-4">
