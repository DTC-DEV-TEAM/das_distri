                ...
                <form method='post' action='{{CRUDBooster::mainpath('edit-save/'.$row->id)}}'>
                    ...
                    <input type="hidden" value="{{ $edit_type }}" name="edit_type" id="edit_type">
                        ...
                        <div class="row"> 
                            ...
                            <label class="control-label col-md-2">Revise ST#/Ref#:</label>
                            <div class="col-md-4">
                                    <input type='input' name='revise_st_number_pull_out' class='form-control' autocomplete="off" required  maxlength="50" placeholder="Revise ST#/Ref#" />   
                            </div>
                        </div>
                        ...
                        <div class="row"> 
                            ...
                            <label class="control-label col-md-2">Revise SOR#/MOR#:</label>
                            <div class="col-md-4">
                                    <input type='input' name='revise_sor_mor_number' class='form-control' autocomplete="off" required  maxlength="50" placeholder="Revise SOR#/MOR#"/>    
                            </div>                          
                        </div>
                        @if($row->revise_sor_mor_number != null)
                            <div class="row"> 
                                <label class="control-label col-md-2">Revise SOR#/MOR#:</label>
                                <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class='col-md-12'>
                                <textarea class="form-control" rows="7" name="comments4" id="comments4" value="{{$row->comments4}}"></textarea>
                            </div>
                        </div>
                </div>
            </div>
            <div class='panel-footer'>           
                <input type='submit' class='btn btn-danger' id="cancelled" value='Revise' style="width:85px;"/>
            </div>
        </form>
    </div>
<!-- The Modal -->
...
$("#cancelled").on('click',function(){
    var strconfirm = confirm("Are you sure you want to revise this pullout request?");
        if (strconfirm == true) {
            return true;
        }else{
            return false;
