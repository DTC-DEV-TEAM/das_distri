                    ...
                    <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                        <div class="row"> 
                            <div class='form-group'>
                                <div class='col-md-5'>    
                                    <label class="control-label">Pullout Schedule:</label>   
                                    <input type='input' name='approved_at_level3' id="datepicker" onkeydown="return false" required  autocomplete="off"  class='form-control' placeholder="yyyy-mm-dd" />                        
                                </div>
                            </div>
                        </div>
                        <hr color="black" >
