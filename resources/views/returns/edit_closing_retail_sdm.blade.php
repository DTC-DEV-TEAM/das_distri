                ...
                <div id="requestform" class='panel-body'>
                    <div> 
                            ...
                            <div class="row"> 
                                ...
                                <label class="control-label col-md-2">{{ trans('message.table.comments3') }}</label>
                                    <div class="col-md-10">
                                    <textarea placeholder="{{ trans('message.table.comments4') }}" rows="3" class="form-control" name="sdm_comments" id="sdm_comments" required></textarea>
                                    </div>
                            </div>
                    </div>
                </div>
