                ...
                <div id="requestform" class='panel-body'>
                    <div> 
                        ...
                        <hr/>
                            ...
                            <hr/>
                            <div class="row">                           
                                <label class="control-label col-md-2">{{ trans('message.form-label.created_crf_by') }}</label>
                                <div class="col-md-4">
                                    <p>{{$row->created_crf_by}}</p>
                                </div>
                                <label class="control-label col-md-2">{{ trans('message.form-label.created_crf_date') }}</label>
                                <div class="col-md-4">
