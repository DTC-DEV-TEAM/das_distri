                    ...
                    <div> 
                           ...
                           <!-- <div class="row" style="background-color: #3C8DBC; height:50px;"> 
                                <div class="col-md-6" style="margin-top: 10px; color: white; font-size: 20px;">
                                        ...
                                        <span >Please Upload Return Form here: </span><a style="margin-top: 2px; color: white;" href="https://drive.google.com/drive/folders/1bx6o1nNMTXpFlzT0u0iCe3Xzik28NLoa?usp=sharing" target="_blank">&nbsp;<i class="fa fa-cloud-upload fa-lg" ></i></a>
                           ...
                           <!-- <div class="row" id="replacement">                           
                            ...
                            @if($row->deliver_to != "WAREHOUSE.RMA.DEP")
                                <div class="row" id="replacement1">
                                    ...
                                    <div class="col-md-4">
                                            <input type='input' name='pos_replacement_ref' id="pos_replacement_ref" class='form-control' autocomplete="off" maxlength="50"  onkeypress="return AvoidSpace(event)"  required placeholder="REP#/ST#/CRF#" />                             
                                    </div>
                                    
                                    <div class="col-md-6">
                                            
                                            <p style="color:red;"><label style="color:black;">Notes:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*IF ECOMM APPLE/BEATS, PLEASE CREATE POS CRF TO SERVICE CENTER.
                                ...
                                <div class="row" >
                                    ...
                                    <label class="control-label col-md-2" >Service Center Location:</label>
