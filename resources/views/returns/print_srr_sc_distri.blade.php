...
<!--
                    ...
                    <tr>
                        <td colspan="4">
                            <label class="control-label col-md-12"><strong>FILLED BY SERVICE CENTER</strong></label>
                        </td>                           
                    </tr>
                    ...
                    <tr style="font-size: 13px;">
                        ...
                        <td width="40%">
                                ...
                                @if($row->received_at_sc	 == null)
                                    ____________________
                                @else 
                                    <p>{{ $row->received_at_sc != null ? date('Y-m-d', strtotime($row->received_at_sc)) : ""}}</p>
                                @endif
                        </td>                      
  ...
  <div class='panel-footer'>
    <form method='GET' id="myform" action="{{route('ReturnsSRRUpdateSCDISTRI')}}" enctype="multipart/form-data">
