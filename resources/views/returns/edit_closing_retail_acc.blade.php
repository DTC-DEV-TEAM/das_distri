        ...
        <form method='post' id="myform" action='{{CRUDBooster::mainpath('edit-save/'.$row->id)}}'>
            ...
            <input type="hidden"  name="closing" id="closing">
                <div id="requestform" class='panel-body'>
                    ...
                    <div class="row"> 
                        <label class="control-label col-md-2" style="margin-top:7px;">{{ trans('message.form-label.date_adjusted') }}</label>
                        <div class="col-md-4">
                                <input type='input'  name='date_adjusted' id="datepicker" onkeydown="return false" required  autocomplete="off"  class='form-control' placeholder="yyyy-mm-dd" />                        
                        </div>     
                    </div>
                    <br>
                    <div class="row"> 
                        ...
                        <div class="col-md-5">
                            <input type='input' name='stock_adj_ref_no' id="stock_adj_ref_no" class='form-control' autocomplete="off" maxlength="50" placeholder="Ref#"  required/>          
