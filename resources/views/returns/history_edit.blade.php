                ...
                <div id="requestform" class='panel-body'>
                    <div>
                            ...
                            <div class="row">  
                                ...
                                <label class="control-label col-md-2"  style="margin-top:4px;">{{ trans('message.form-label.ship_back_status') }}</label>
                                <div class="col-md-4">
                                    <select class="js-example-basic-single" name="ship_back_status" id="ship_back_status"  style="width:100%">
                                                    <option value="">-- Select Ship Back Status --</option>

                                                    @foreach($ShipBackStatus as $datas)    
                                                        @if($row->ship_back_status == $datas->id)
                                                                <option selected value="{{$datas->id}}">{{$datas->ship_back_status_name}}</option>
                                                            @else
                                                                <option  value="{{$datas->id}}">{{$datas->ship_back_status_name}}</option>
                                                        @endif    
                                                    @endforeach
                                ...
                                <label class="control-label col-md-2"  style="margin-top:4px;">{{ trans('message.form-label.claimed_status') }}</label>
                                <div class="col-md-4">
                                    <select class="js-example-basic-single" name="claimed_status" id="claimed_status"  style="width:100%">
                                                    <option value="">-- Select Claimed Status --</option>
                                                    
                                                    @foreach($ClaimedStatus as $datas)   
                                                        @if($row->claimed_status == $datas->id)
                                                                <option selected value="{{$datas->id}}">{{$datas->claimed_status_name}}</option>
                                                            @else
                                                                <option  value="{{$datas->id}}">{{$datas->claimed_status_name}}</option>
                                                        @endif                                                       
                                                    @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <label class="control-label col-md-2" style="margin-top:7px;">{{ trans('message.form-label.credit_memo_number') }}</label>
                                <div class="col-md-4">
                                    <input type='input' name='credit_memo_number' id="credit_memo_number" class='form-control' autocomplete="off" maxlength="50" placeholder="Credit Memo#" value="{{$row->credit_memo_number}}"  />                             
                                </div>
                            </div>  
                            <hr/>
                            <!-- 1r -->
