                           ...
                           <div id="locations"> 
                            ...
                            <div class="row" id="replacement">                           
                                ...
                                <div class="col-md-6">
                                        ...
                                        <p ><label >Notes:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*IF APPLE/BEATS, PLEASE CREATE MW STS TRANSACTION TO SERVICE CENTER. 
                                            <br/>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            
                                            *IF OTHER BRANDS, PLEASE CREATE POS REPLACEMENT TRANSACTION.
                                        </p>
                            ...
                            <div class="row" id="replacement1">
                                ...
                                <div class="col-md-4">
                                        <input type='input' name='pos_replacement_ref' id="pos_replacement_ref" class='form-control' autocomplete="off" maxlength="50"  onkeypress="return AvoidSpace(event)"  required placeholder="REP#/ST#" />                             
                                </div>
