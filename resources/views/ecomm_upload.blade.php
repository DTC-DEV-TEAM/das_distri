...
<div id='box_main' class="box box-primary">
    ...
    <form method='post' id="form" enctype="multipart/form-data" action="{{ route('upload.importECOMM') }}">
        ...
        <div class="box-body">
            ...
            <div class='callout callout-success'>
                ...
                1. Blank value is not allowed.<br/>
            ...
            <div class='col-sm-4'>
                <input type='file' name='import_file' class='form-control' required accept=".xlsx"/>
