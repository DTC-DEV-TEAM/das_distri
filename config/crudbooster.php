...
return [
    ...
    */
    ...
    'IMAGE_FIELDS_CANDIDATE' => 'image,picture,photo,photos,thumbnail',

    'PASSWORD_FIELDS_CANDIDATE' => 'password,pass,pwd,pin',

    'DATE_FIELDS_CANDIDATE' => 'date,created_at,updated_at,deleted_at',

    'EMAIL_FIELDS_CANDIDATE' => 'email,mail,email_address',

    'PHONE_FIELDS_CANDIDATE' => 'phone,phonenumber,phone_number',

    'NAME_FIELDS_CANDIDATE' => 'name,person_name,person,fullname,full_name,nickname,nick,nick_name,title,content',
